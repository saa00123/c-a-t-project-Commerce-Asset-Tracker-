...
export default function Show({ asset, availableChannels }) {
    ...
    const removeFile = () => {
        if (
            confirm(
                "Are you sure you want to completely remove this file from S3?",
            )
        ) {
                ...
                <div className="w-full md:w-1/2 space-y-6">
                    ...
                    <div className="bg-white p-6 shadow-sm sm:rounded-lg">
                        ...
                        {asset.file_url ? (
                            <div className="mt-6 flex flex-col items-center">
                                {asset.type === "VIDEO" ? (
                                    ...
                                    <img
                                        src={asset.file_url}
                                        alt={asset.title}
                                        className="w-full max-h-96 rounded-md object-contain bg-gray-50 border border-gray-200"
                                    />
                                )}
                            ...
                            <div className="mt-6 relative flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 py-16 bg-gray-50 hover:bg-gray-100 transition-colors">
                                <input
                                    type="file"
